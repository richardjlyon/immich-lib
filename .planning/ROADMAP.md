...
- [ ] **Phase 1: Foundation** - Rust project setup, API client, authentication
- [ ] **Phase 2: Duplicate Discovery** - Fetch duplicate groups and asset metadata
...
**Depends on**: Phase 1
**Research**: Likely (Immich duplicate and asset endpoints)
**Research topics**: Duplicate groups endpoint, asset metadata endpoint, EXIF data structure in responses
**Plans**: TBD
